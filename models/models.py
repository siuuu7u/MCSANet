...
from modules.base import BaseCMN
...
class BaseCMNModel(nn.Module):
    ...
    def forward_iu_xray(self, images, targets=None, labels=None, mode='train', update_opts={}):
        att_feats_0,  fc_feats_0 = self.visual_extractor(images[:, 0])#(16,49,2048),(16,2048)
    ...
    def forward_mimic_cxr(self, images, targets=None,labels=None, mode='train', update_opts={}):
