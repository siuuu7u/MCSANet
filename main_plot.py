...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/mnt/mimic_cxr/images/',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/mnt/mimic_cxr/qualitative.json',
                        help='the path to the directory containing the data.')
    parser.add_argument('--label_path', type=str, default='files/mimic_cxr/labels_14.pickle',
                        help='the path to the directory containing the data.')
    ...
    parser.add_argument('--visual_extractor', type=str, default='densenet121', choices=['resnet101', 'densenet121'], help='the visual extractor to be used.')
    ...
    parser.add_argument('--topk', type=int, default=128, help='the number of k.')
    ...
    parser.add_argument('--temperature', type=float, default=0.8, help='the temperature when sampling.')
    ...
    parser.add_argument('--save_dir', type=str, default='/home/user2/zzhData/r2gencmn/results/mimic_cxr/all/', help='the patch to save the models.')
    ...
    # Others
    parser.add_argument('--seed', type=int, default=1246, help='.')
    parser.add_argument('--resume', type=str, help='whether to resume the training from existing checkpoints.')
    parser.add_argument('--load', type=str, default='/home/user2/zzhData/r2gencmn/results/mimic_cxr/all/model_best.pth',help='whether to load the pre-trained model.')
