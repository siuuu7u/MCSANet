...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/home/user2/zzhData/iu_xray/images/',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/home/user2/zzhData/iu_xray/annotation.json',
                        help='the path to the directory containing the data.')
    ...
    parser.add_argument('--visual_extractor', type=str, default='resnet101', choices=['resnet101', 'densenet121'], help='the visual extractor to be used.')
    ...
    parser.add_argument('--topk', type=int, default=64, help='the number of k.')
    ...
    parser.add_argument('--save_dir', type=str, default='results/iu_xray/qu_loss', help='the patch to save the models.')
    ...
    # Others
    parser.add_argument('--seed', type=int, default=1246, help='1246，12839')
    parser.add_argument('--resume', type=str, help='whether to resume the training from existing checkpoints.')
    parser.add_argument('--weight_img_con_loss', type=float, default=1, help='.')
    parser.add_argument('--weight_txt_con_loss', type=float, default=0.1, help='.')
...
def main():
    ...
    plt.plot(range(1, len(trainer.train_losses) + 1), trainer.train_losses, marker='o', label='Training Loss')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
