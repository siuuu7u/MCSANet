...
from modules.utils import generate_heatmap,generate_heatmap_iu_xray
...
class BaseTester(object):
    def __init__(self, model, criterion, metric_ftns, args):
        ...
        self.chexbert_metrics = CheXbertMetrics('./checkpoints/stanford/chexbert/chexbert.pth', args.batch_size,
                                                self.device)
...
class Tester(BaseTester):
    ...
    def plot(self):
        ...
        ner_dir = "/home/user2/zzhData/R2GenCMN111/results/ner/en_core_sci_sm-0.5.4/en_core_sci_sm/en_core_sci_sm-0.5.4/"
        ner = spacy.load(ner_dir)
