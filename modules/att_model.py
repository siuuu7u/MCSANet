...
class AttModel(CaptionModel):
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, opt={}, labels = None):
        ...
        # print(f'p_fc_feats.shape={p_fc_feats.shape}')[16, 1]
        # print(f'p_att_feats.shape={p_att_feats.shape}')[16, 98, 1]
        # print(f'pp_att_feats.shape={pp_att_feats.shape}')[16, 98, 512]
        # print(f'p_att_masks.shape={p_att_masks.shape}')[16, 1, 98]
        ...
        self.done_beams = self.beam_search(state, logprobs, p_fc_feats, p_att_feats, pp_att_feats, p_att_masks, labels, opt=opt)
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None, labels = None, update_opts={}):
        ...
        # print(fc_feats.shape)16 2048*2
        # print(att_feats.shape)16 49*2 2048
